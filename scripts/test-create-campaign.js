...
// Simple local generator (aligned with frontend fields)
...
async function main() {
  // point admin SDK to emulator if FIRESTORE_EMULATOR_HOST is set
  ...
  // Also store ai_campaign summary under users/{uid}/ai_campaigns
  const summary = {
    campaignId: id,
