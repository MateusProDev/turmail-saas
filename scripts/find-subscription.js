...
function usage() {
  console.log('Usage: node scripts/find-subscription.js --id <stripeSubscriptionId>')
  console.log('   or: node scripts/find-subscription.js --email <email>')
  console.log('   or: node scripts/find-subscription.js --customer <stripeCustomerId>')
}
